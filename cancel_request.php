...
if(empty($d_res_id) || empty($d_inc_id)) {
    ...
    try {
        ...
        if (mysqli_query($con, $s_upd_assignment_query)) {
            $msg = "Successfully cancelled the request for Resource_ID:".$d_res_id ." and the Incident: ".$d_inc_id;
        } else{
          $msg = "Error while Cancelling the request for Resource_ID:".$d_res_id." and the Incident:".$d_inc_id;
        }
